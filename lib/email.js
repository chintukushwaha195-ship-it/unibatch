/**
 * lib/email.js — SMTP helpers via nodemailer.
 *
 * All environment variables are validated before use.
 * Both functions throw on failure — callers must catch.
 *
 * SMTP_HOST/SMTP_PORT are configurable so this works with Gmail,
 * Outlook/Office 365, or any other provider. Defaults to Gmail.
 */
...
// SMTP_USER is authenticated as — most providers (Gmail included) require
// From == the logged-in account, or they silently rewrite/reject it. Set
// SMTP_USER to your real Gmail address (with an App Password, not your
// normal login password) for mail to arrive correctly.
